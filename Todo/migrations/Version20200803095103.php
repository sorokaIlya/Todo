 ...
 */
final class Version20200803095103 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE todo ALTER id TYPE VARCHAR(255)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE "todo" ALTER id TYPE INT');
        $this->addSql('ALTER TABLE "todo" ALTER id DROP DEFAULT');
    }
}
